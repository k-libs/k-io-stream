...
group = "io.k-libs"
version = "0.1.0"
description = "IO stream definitions."
  ...
  publications {
    withType<MavenPublication> {
      ...
      pom {
        ...
        scm {
          connection.set("scm:git:git://github.com/k-libs/k-io-stream.git")
          developerConnection.set("scm:git:ssh://github.com/k-libs/k-io-stream.git")
          url.set("https://github.com/k-libs/k-io-stream")
        }
      }
    }
